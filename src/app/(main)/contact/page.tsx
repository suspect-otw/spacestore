            ...
            <div className="mx-auto max-w-4xl px-4 lg:px-0">
                ...
                <div className="grid divide-y border md:grid-cols-2 md:gap-4 md:divide-x md:divide-y-0">
                    <div className="flex flex-col justify-between space-y-8 p-6 sm:p-12">
                        <div>
                            <h2 className="mb-3 text-lg font-semibold">Mail Us</h2>
                            <Link href="mailto:info@spacestoreone.com" className="text-lg text-blue-600 hover:underline dark:text-blue-400">
                            info@spacestoreone.com
                            </Link>
                        ...
                        <div className="**:[&>label]:block mt-12 space-y-6 *:space-y-3">
                            ...
                            <div>
                                ...
                                <Select>
                                    ...
                                    <SelectContent>
                                        <SelectItem value="1">Turkey</SelectItem>
